...
export const leads = {
    data() {
        return {
            ...
            leadsform: {
                ...
                productPrice: null,
                crossProduct: null,
                crossProductCount: null,
                crossProductPrice: null,
                upsellProduct: null,
                upsellProductCount: null,
                upsellProductPrice: null,
                shippingPrice: null,
                postOrder: 0,
    ...
    methods: {
        getLeads() {
            ...
            axios({
                method: "post",
                url: "/v1/lead/list?filter=" + filter + "&sort=" + sort,
                data: {
        ...
        getLead() {
            axios({
                ...
                .then(response => {
                    ...
                    this.leadsform.crossProduct = this.leadInfo.crossProduct;
                    this.leadsform.crossProductCount = this.leadInfo.crossProductCount;
                    this.leadsform.crossProductPrice = this.leadInfo.crossProductPrice;
                    this.leadsform.upsellProduct = this.leadInfo.upsellProduct;
                    this.leadsform.upsellProductCount = this.leadInfo.upsellProductCount;
                    this.leadsform.upsellProductPrice = this.leadInfo.upsellProductPrice;
                    this.leadsform.shippingPrice = this.leadInfo.shippingPrice;
                    this.leadsform.postOrder = this.leadInfo.rejectionReason > 0 ? 1 : 0;
        ...
        addLead() {
            ...
            formData.append("form[firstCallAt]", this.leadsform.firstCallAt);
            formData.append("form[completedAt]", this.leadsform.completedAt);
            ...
            formData.append("form[crossProduct]", this.leadsform.crossProduct);
            formData.append(
                "form[crossProductCount]",
                this.leadsform.crossProductCount
            );
            formData.append(
                "form[crossProductPrice]",
                this.leadsform.crossProductPrice
            );
            formData.append("form[upsellProduct]", this.leadsform.upsellProduct);
            formData.append(
                "form[upsellProductCount]",
                this.leadsform.upsellProductCount
            );
            formData.append(
                "form[upsellProductPrice]",
                this.leadsform.upsellProductPrice
            );
        ...
        removeLeads(redirect = false) {
            ...
            axios({
                ...
                ({ data }) => {
                    vm.inProgress = false;
                    let elem = this.$refs.leadsRemoveClose;
                    elem.click();
                    if (redirect) {
